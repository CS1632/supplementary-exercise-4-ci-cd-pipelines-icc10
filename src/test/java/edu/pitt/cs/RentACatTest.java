...
public class RentACatTest {
	...
	public void setUp() throws Exception {
		...
		Mockito.when(c1.toString()).thenReturn(String.format("ID %d. %s", 1, "Jennyanydots"));
		...
		Mockito.when(c2.toString()).thenReturn(String.format("ID %d. %s", 2, "Old Deuteronomy"));
		...
		Mockito.when(c3.toString()).thenReturn(String.format("ID %d. %s", 3, "Mistoffelees"));
	}
